          ...
          {categories.map((category, index) => {
            ...
            return (
              <Link
                ...
                key={category.id}
                className="group relative aspect-[4/5] overflow-hidden rounded-2xl bg-slate-200 shadow-sm ring-1 ring-black/5 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-2xl hover:shadow-violet-950/20 focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-4 focus-visible:outline-none sm:aspect-[4/3] lg:aspect-[4/5]"
              >
                {imageSrc ? (
                  <Image
                    src={imageSrc}
