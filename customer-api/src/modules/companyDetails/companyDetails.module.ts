...
import { StoreSettingsController } from '@/src/modules/companyDetails/controllers/companyDetails.controller';

@Module({
  imports: [TypeOrmModule.forFeature([CompanyDetailEntity])],
  controllers: [CompanyDetailsController, StoreSettingsController],
