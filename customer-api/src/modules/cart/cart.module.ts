...
import { AbandonedCartWorker } from './abandoned-cart.worker';
...
@Module({
  ...
  providers: [CartService, AuthGuard, AbandonedCartWorker],
  exports: [CartService],
})
